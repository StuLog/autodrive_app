...
#include "custom_messages/msg/detail/lanetype__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_messages::msg::Lanetype & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: lanetype_name
  cdr << ros_message.lanetype_name;
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_messages::msg::Lanetype & ros_message)
{
  // Member: lanetype_name
  cdr >> ros_message.lanetype_name;
...
{
  auto typed_message =
    static_cast<const custom_messages::msg::Lanetype *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_messages::msg::Lanetype *>(
    untyped_ros_message);
...
{
  return &custom_messages::msg::typesupport_fastrtps_cpp::_Lanetype__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_messages, msg, Lanetype)() {
  return &custom_messages::msg::typesupport_fastrtps_cpp::_Lanetype__handle;
}
