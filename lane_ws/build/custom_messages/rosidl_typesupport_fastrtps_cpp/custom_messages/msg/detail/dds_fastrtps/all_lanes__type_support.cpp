...
#include "custom_messages/msg/detail/all_lanes__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const custom_messages::msg::ParentMessage &,
...
cdr_serialize(
  const custom_messages::msg::AllLanes & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_messages::msg::AllLanes & ros_message)
{
  // Member: lanes
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: lanes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        custom_messages::msg::typesupport_fastrtps_cpp::max_serialized_size_ParentMessage(
...
{
  auto typed_message =
    static_cast<const custom_messages::msg::AllLanes *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_messages::msg::AllLanes *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _AllLanes__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const custom_messages::msg::AllLanes *>(
...
static size_t _AllLanes__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_AllLanes(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _AllLanes__callbacks = {
  "custom_messages::msg",
  "AllLanes",
...
static rosidl_message_type_support_t _AllLanes__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_AllLanes__callbacks,
...
{
  return &custom_messages::msg::typesupport_fastrtps_cpp::_AllLanes__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_messages, msg, AllLanes)() {
  return &custom_messages::msg::typesupport_fastrtps_cpp::_AllLanes__handle;
}
