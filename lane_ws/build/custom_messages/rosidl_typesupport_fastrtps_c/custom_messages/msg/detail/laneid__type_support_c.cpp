...
#include "custom_messages/msg/detail/laneid__rosidl_typesupport_fastrtps_c.h"
...
using _Laneid__ros_msg_type = custom_messages__msg__Laneid;
...
static uint32_t _Laneid__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_messages__msg__Laneid(
...
static size_t _Laneid__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_messages__msg__Laneid(
