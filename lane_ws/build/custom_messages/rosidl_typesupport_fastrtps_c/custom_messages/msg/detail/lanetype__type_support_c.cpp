...
#include "custom_messages/msg/detail/lanetype__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // lanetype_name
#include "rosidl_runtime_c/string_functions.h"  // lanetype_name

// forward declare type support functions


using _Lanetype__ros_msg_type = custom_messages__msg__Lanetype;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: lanetype_name
  {
    const rosidl_runtime_c__String * str = &ros_message->lanetype_name;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: lanetype_name
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->lanetype_name.data) {
      rosidl_runtime_c__String__init(&ros_message->lanetype_name);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->lanetype_name,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'lanetype_name'\n");
      return false;
    }
  }
  ...
  size_t current_alignment)
{
  ...
  current_alignment += padding +
    ...
    (ros_message->lanetype_name.size + 1);
...
static uint32_t _Lanetype__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_messages__msg__Lanetype(
...
static size_t _Lanetype__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_messages__msg__Lanetype(
